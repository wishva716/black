...
print  """
               ...
               🇼​​​​​🇮​​​​​🇸​​​​​🇭​​​​​🇻​​​​​🇦​​​​​ 🇯​​​​​🇦​​​​​🇾​​​​​
  𝔹𝕃𝔸ℂ𝕂 ℍ𝔸ℂ𝕂𝔼ℝ  𝔹𝕃𝔸ℂ𝕂 ℍ𝔸ℂ𝕂𝔼ℝ    𝔹𝕃𝔸ℂ𝕂 ℍ𝔸ℂ𝕂𝔼ℝ
...
\033[1;92mWHATAAPP
                     0750285325
\033[1;97m•••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••      
\033[1;96mBlacklist 𝙱𝙻𝙰𝙲𝙺 𝙷𝙰𝙲𝙺𝙴𝚁 𝚃𝙴𝙰𝙼 Sky..
\033[1;97m•••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••••                
\033[1;92m----------------ＷＩＳＨＶＡ------------------
"""
...
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
        ...
        if (password == CorrectPassword):
            print "ADO KOLLO LOG BN" + username #Dev:love_hacker
	    time.sleep(2)
            loop = 'false'
        else:
            print "\033[1;94mWrong Password"
            os.system('xdg-open https://m.facebook.comWISHVAJAY.com')
    else:
...
def Zeek():
    ...
    time.sleep(0.10)
    print '\x1b[1;92m[2] WISHVA FB ACCOUNT'
    time.sleep(0.10)
    ...
    time.sleep(0.10)
    print '\x1b[1;91m[6]  WISHVA FACEBOOK'
    time.sleep(0.10)
...
\033[1;95mFb\033[1;97wishva jay
